            ...
            <div className="section_wrapper">
                <div className="about_me_body">
                    ...
                    <p className="about_me_text">
                        ...
                        <a href="#" target="_blank" rel="noreferrer"> Introduction to Computer Science and Programming</a> offered by
                        <a href="#" target="_blank" rel="noreferrer"> MITOPENCOURSEWARE</a>, which opened my eyes to the world of programming, ultimately leading me to embark on the journey
                    ...
                    <p className="about_me_text">
                        ...
                        JavaScript Algorithms and Data Structures</a> courses offered by <a href="#" target="_blank" rel="noreferrer">freeCodeCamp;</a> as well as two short courses on Udemy on ES6 and React.
